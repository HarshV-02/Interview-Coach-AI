  ...
  return (
    ...
    <div>
      ...
      <main className="min-h-screen">
        {/* Header Section */}
        <header className="w-full py-8 bg-yellow-100 shadow-md">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
            <h1 className="text-3xl font-bold text-primary">AI Mock Interview Coach</h1>
            <nav className="flex flex-col sm:flex-row flex-wrap items-center justify-between mt-4 md:mt-0 space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0">
                <a href="#features" className="text-lg text-yellow-800 mx-2 md:mx-4">Features</a>
                <a href="#testimonials" className="text-lg text-yellow-800 mx-2 md:mx-4">Testimonials</a>
                <a href="#contact" className="text-lg text-yellow-800 mx-2 md:mx-4">Contact</a>
              </div>
            </nav>
          </div>
        </header>
        ...
        {/* Hero Section */}
        <section className="flex flex-col items-center justify-center text-center py-20 bg-gradient-to-r from-yellow-900 to-yellow-400  px-6 md:px-0">
          ...
          <div className="mt-6 flex flex-col md:flex-row">
            <a
              href="/dashboard"
              className="px-6 py-3 mb-4 md:mb-0 md:mr-4 text-lg font-semibold bg-white !text-yellow-600 rounded-lg shadow-lg hover:bg-yellow-100"
            >
              Get Started
            </a>
            <a
              href="#features"
              className="px-6 py-3 text-lg font-semibold border border-white rounded-lg hover:bg-white hover:text-yellow-600"
            >
              Learn More
            </a>
          </div>
        ...
        <section id="features" className="py-16 bg-white px-6 md:px-0">
          <div className="container mx-auto text-center">
            <h2 className="text-4xl font-bold text-yellow-800">Features</h2>
            ...
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/3 px-4 py-8">
                <div className="bg-yellow-50 rounded-lg p-6 shadow-md">
                  ...
                  <p className="mt-2 text-yellow-600">Experience realistic interview scenarios with our advanced AI.</p>
                </div>
              </div>
              <div className="w-full md:w-1/3 px-4 py-8">
                <div className="bg-yellow-50 rounded-lg p-6 shadow-md">
                  <h3 className="text-2xl font-semibold text-black-600">Instant Feedback</h3>
                  <p className="mt-2 text-yellow-600">Get instant, personalized feedback to improve your performance.</p>
                </div>
              </div>
              <div className="w-full md:w-1/3 px-4 py-8">
                <div className="bg-yellow-50 rounded-lg p-6 shadow-md">
                  <h3 className="text-2xl font-semibold text-black-600">Comprehensive Reports</h3>
                  <p className="mt-2 text-yellow-600">Receive detailed reports highlighting your strengths and weaknesses.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="testimonials" className="py-16 bg-yellow-50 px-6 md:px-0">
          <div className="container mx-auto text-center">
            <h2 className="text-4xl font-bold text-yellow-800">What Our Users Say</h2>
            <div className="flex flex-wrap justify-center mt-8">
      ...
      <footer className="py-8 bg-yellow-400 text-black text-center">
