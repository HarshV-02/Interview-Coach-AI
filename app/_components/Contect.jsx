...
const Contect = () => {
  ...
  return (
    <div className="container mx-auto text-center">
      <h2 className="text-4xl font-bold text-yellow-800">Get In Touch</h2>
      ...
      <div className="mt-8">
        <form onSubmit={onSubmit} className="max-w-xl mx-auto">
          ...
          <button
            type="submit"
            className="px-6 py-3 text-lg font-semibold bg-yellow-600 text-white rounded-lg shadow-lg hover:bg-gray-700"
          >
            {loading ? (
